...
var movieList = [{
    ...
    "Director": "N/A",
    "Writer": "Jack Kirby, Kari Rosenberg, Joe Simon, Wendy Willming",
    "Actors": "Fred Tatasciore, Roger Craig Smith, Troy Baker, Bumper Robinson",
    "Plot": "The further adventures of the Marvel Universe's mightiest general membership superhero team.",
    "Language": "English",
    "Country": "USA",
    "Awards": "6 nominations.",
    "Poster": "http://ia.media-imdb.com/images/M/MV5BMTY0NTUyMDQwOV5BMl5BanBnXkFtZTgwNjAwMTA0MDE@._V1_SX300.jpg",
    "Metascore": "N/A",
    "imdbRating": "7.0",
    "imdbVotes": "2,812",
    "imdbID": "tt2455546",
    ...
    "Country": "USA, Canada",
    "Awards": "Nominated for 1 Golden Globe. Another 3 wins & 29 nominations.",
    "Poster": "http://ia.media-imdb.com/images/M/MV5BMTQ5MTUxMzU3Ml5BMl5BanBnXkFtZTgwMDU3NDYxMjE@._V1_SX300.jpg",
    "Metascore": "N/A",
    "imdbRating": "8.2",
    "imdbVotes": "57,911",
    "imdbID": "tt1637727",
    ...
    "Writer": "Vera Caspary (novel), Jay Dratler (screen play), Samuel Hoffenstein (screen play), Elizabeth Reinhardt (screen play)",
    ...
    "Poster": "http://ia.media-imdb.com/images/M/MV5BMTU5MjQwMzk1NF5BMl5BanBnXkFtZTcwOTA5NDgyMw@@._V1_SX300.jpg",
    "Metascore": "N/A",
    "imdbRating": "8.1",
    "imdbVotes": "27703",
    "imdbID": "tt0037008",
    ...
    "Writer": "N/A",
    "Actors": "N/A",
    "Plot": "Sunset Boulevard is the attempt to simultaneously picture the two big, contradictory myths of U.S. America: the myth of unlimited individualism (\"lonesome rider\"), and the myth of the \"...",
    "Language": "N/A",
    "Country": "Austria",
    "Awards": "N/A",
    "Poster": "http://ia.media-imdb.com/images/M/MV5BMTg1NzE0MzM5OF5BMl5BanBnXkFtZTYwMTMyNjk5._V1_SX300.jpg",
    "Metascore": "N/A",
    "imdbRating": "8.2",
    "imdbVotes": "29",
    "imdbID": "tt0158253",
...
//Set Random movies as favourites on load
_.times(getRandomInt(4,9), function(){
    favourites[movieList[getRandomInt(0,241)].imdbID] = 1;
});

// Get list of movies
exports.index = function(req, res) {
  res.json(_.map(movieList, function(movie){
    return {
        Title : movie.Title,
        Year : movie.Year,
        Plot : movie.Plot,
        ...
        Poster : movie.Poster,
        imdbID : movie.imdbID,
        favourite : favourites[movie.imdbID]
    }
  }));
};
...
exports.getMovie = function(req, res) {
  var imdbRef = req.params.imdbID;
  var movie = _.find(movieList, { imdbID : imdbRef });
  if (!movie) {
    res.json({error : 'Invalid imdb key'});
  } else {
    if (_.isArray(movie)) movie = movie[0];
    res.json(_.extend(movie, { favourite : favourites[imdbRef]}));
  }
};

exports.getFavourites = function(req, res) {
    var favIndices = [];
    _.each(favourites, function(value, key) {
        var index = _.findIndex(movieList, { imdbID : key });
        if (index >= 0) {
            favIndices.push(index);
        }
    })
    res.json(_.map(favIndices, function(favIndex){
        var movie = movieList[favIndex];
        return {
            Title : movie.Title,
            Year : movie.Year,
            Plot : movie.Plot,
...
exports.setUnsetFavourite = function(req, res) {
    var imdbRef = req.body.imdbID;
    if (favourites[imdbRef]) {
        delete favourites[imdbRef];
    } else {
        favourites[imdbRef] = 1;
    }
    return res.json( { imdbID : imdbRef, favourite: favourites[imdbRef]});
}
